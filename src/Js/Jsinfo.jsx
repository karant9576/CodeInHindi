...
const Jsinfo = () => {
  ...
  const jsTopics = [
    ...
    {
      label: "JS Variable Length Argument Function ",
      path: "js-var-length-arg-function",
    },
    ...
    {
      label: "Js Static Properties and Methods  : Js Class",
      path: "js-class-static",
    },
    {
      label: "Js Inheritance  | JS Inheritance Explained ",
      path: "js-inheritance",
    },
  ];
